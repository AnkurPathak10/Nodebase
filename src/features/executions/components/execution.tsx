                    ...
                    {execution.error && (
                        <div className="mt-6 p-4 bg-red-50 rounded-md space-y-3">
                            <div>
                                ...
                                <p className="text-sm text-red-800 font-mono break-all whitespace-pre-wrap min-w-0">
                                    {execution.error}
                                </p>
                            </div>
                            ...
                            {execution.errorStack && (
                                ...
                                >
                                    ...
                                    <CollapsibleContent>
                                            <pre className="text-xs font-mono text-red-800 whitespace-pre-wrap break-all overflow-auto mt-2 p-2 bg-red-100 rounded min-w-0">
                                                {execution.errorStack}
                                            </pre>
                                    </CollapsibleContent>
                                </Collapsible>
