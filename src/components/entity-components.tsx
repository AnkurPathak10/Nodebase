...
export const EntityHeader = ({
    title, description, onNew, newButtonHref, newButtonLabel, disabled, isCreating
}: EntityHeaderProps) => {
    return (
...
export const EntitySearch = ({
    ...
    return (
        <div className="relative ml-auto">
            ...
            <Input 
                className="max-w-[200px] bg-background shadow-none boarder-boarder pl-8"
